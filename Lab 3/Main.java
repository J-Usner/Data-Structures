public class Main {
  public static void main(String[] args) {
    ...
    System.out.println("Elapsed Time for best-case: " + elapsedTimeBest + " nanoseconds.");

    String worstCase = "ZZZZZZZZZZ";
    ...
    System.out.println("Elapsed Time for worst-case: " + elapsedTimeWorst + " nanoseconds.");
  }
